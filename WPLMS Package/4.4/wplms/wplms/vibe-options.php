...
$args['help_tabs'][] = array(
							...
							'content' => '<ul><li><a href="https://wplms.io/supportforums/" target="_blank">'.THEME_FULL_NAME.' Support Panel</a></li>
	                                          <li><a href="https://wplms.io/supportknowledge-base/one-click-setup-wplms-demo1/" target="_blank">'.THEME_FULL_NAME.' Theme Setup</a></li>
	                                          <li><a href="https://wplms.io/supportarticle-categories/faqs/" target="_blank">'.THEME_FULL_NAME.' Common FAQs/Issues</a></li>  
	                                          <li><a href="https://wplms.io/supportarticle-categories/tips-tricks/" target="_blank">'.THEME_FULL_NAME.' Tips and Tricks</a></li>
	                                          <li><a href="https://wplms.io/supportforums/forum/general/feature-request/" target="_blank">'.THEME_FULL_NAME.' Feature Requests</a></li>    
	                                          <li><a href="https://wplms.io/supportarticle-categories/update-log/" target="_blank">'.THEME_FULL_NAME.' Update Log</a></li>    
...
$args['help_sidebar'] = '<p>For Support/Help and Docuementation open <strong><a href="https://wplms.io/support">'.THEME_FULL_NAME.' forums</a></strong>'.__('Or email us at','vibe').' <a href="mailto:vibethemes@gmail.com">vibethemes@gmail.com</a>. </p>';
...
$sections[] = array(
				...
				'desc' => '<p class="description">'.sprintf(__('Welcome to %s Theme Options panel. ','vibe'),THEME_FULL_NAME).'</p>
                                    <ol>
                                        ...
                                        <li>'.__('Facing issues? Create a support thread. ','vibe').' <a href="https://wplms.io/supportforums/" class="button" target="_blank">'.__('Full Theme Guide','vibe').'</a></li> 
                                        <li>'.__('How to Update? Facing Issues while updating?','vibe').' <a href="https://wplms.io/supportknowledge-base/auto-updating-wplms/">Auto updating WPLMS.</a></li>     
                                    </ol>
...
$sections[] = array(
				...
				'fields' => array(
                       ...
                       array(
						...
						'desc' => sprintf(__('This Logo is shown in header. NOT ABLE TO UPLOAD ? %s REFER TIP %s', 'vibe'),'<a href="https://wplms.io/supportknowledge-base/logo-and-favicon-not-uploading/" target="_blank">','</a>'),
                       ...
                       array(
						...
						'desc' => sprintf(__('This Logo is shown in header on Mobile devices, less than 768px wide. NOT ABLE TO UPLOAD ? %s REFER TIP %s', 'vibe'),'<a href="https://wplms.io/supportknowledge-base/logo-and-favicon-not-uploading/" target="_blank">','</a>'),
                        'std' => VIBE_URL.'/assets/images/logo.png'
						),
                       array(
						'id' => 'alt_logo',
						...
						'desc' => sprintf(__('This Logo is shown in header when it becomes fixed. Or in the Header top area. Defaults to logo.NOT ABLE TO UPLOAD ? %s REFER TIP %s', 'vibe'),'<a href="https://wplms.io/supportknowledge-base/logo-and-favicon-not-uploading/" target="_blank">','</a>'),
                        'std' => VIBE_URL.'/assets/images/logo.png'
						),
                        array(
						'id' => 'favicon',
						...
						'desc' => sprintf(__('Upload 16x16px Favicon.NOT ABLE TO UPLOAD ? %s REFER TIP %s', 'vibe'),'<a href="https://wplms.io/supportknowledge-base/logo-and-favicon-not-uploading/" target="_blank">','</a>'),
...
$sections[] = array(
				...
				'fields' => array(
					array(
						...
						'desc' => sprintf(__('This avatar is shown for members who have not uploaded any custom avatar.NOT ABLE TO UPLOAD ? %s REFER TIP %s', 'vibe'),'<a href="https://wplms.io/supportknowledge-base/logo-and-favicon-not-uploading/" target="_blank">','</a>'),
                    ...
                    array(
                        ...
                        'sub_desc' => '[Legacy v3 or below]'. sprintf(__('Add social profiles in user profiles. %s refer tutorial %s', 'vibe'),'<a href=" http://wplms.io/support/knowledge-base/social-profile-field-group/ ">','</a>'),
                        'std'=>'Social Profiles'
						),
					array(
                    ...
                    array(
                        ...
                        'desc' => '[Legacy v3 or below]'. __('Registration & Forgot password forms open inside login form.','vibe').'<a href="https://wplms.io/supportknowledge-base/ajax-login-and-registration-in-wplms">more</a>',
...
$sections[] = array(
				...
				'fields' => array(
						...
						'desc' => sprintf(__('This avatar is shown for courses which do not have any avatar. NOT ABLE TO UPLOAD ? %s REFER TIP %s', 'vibe'),'<a href="https://wplms.io/supportknowledge-base/logo-and-favicon-not-uploading/" target="_blank">','</a>'),
                        'std' => ''
						),
						array(
						'id' => 'hide_courses',
                        ...
                        'desc' => sprintf(__('User redirects to Directory with category activated when she selects course category %s refer tutorial %s', 'vibe'),'<a href="https://wplms.io/support/knowledge-base/course-category-redirect-to-course-directory/" target="_blank" class="link">','</a>'),
                        'type' => 'button_set',
						'options' => array('' => __('No','vibe'),'1'=>__('Yes','vibe')),
						'std' => ''
						),
				...
				'fields' => array(
					array(
					 ...
					 array(
                        ...
                        'sub_desc' => __(' Custom Fonts are added to Theme Customizer Font List.. ', 'vibe').'<a href="https://wplms.io/supportknowledge-base/add-custom-fonts-in-wplms/">Learn how to add custom fonts</a>'
						)
...
$sections[] = array(
				...
				'fields' => array( 
						...
						'desc' => sprintf(__('This Logo is shown in footer bottom area. Defaults to logo. NOT ABLE TO UPLOAD ? %s REFER TIP %s', 'vibe'),'<a href="https://wplms.io/support/knowledge-base/logo-and-favicon-not-uploading/" target="_blank">','</a>'),
                        'std' => VIBE_URL.'/assets/images/logo.png'
						),
                        array(
							'id' => 'copyright',
...
$sections[] = array(
				...
				'fields' => array(
						...
						'sub_desc' => __('Enter Google captcha public key', 'vibe').'<a href="https://wplms.io/supportknowledge-base/google-captcha-public-and-private-keys/">'.__('How to get an Public Key ?','vibe').'</a>',
						'std' => ''
						),
						array(
						...
						'sub_desc' => __('Enter Google captcha private key', 'vibe').'<a href="hhttps://wplms.io/supportknowledge-base/google-captcha-public-and-private-keys/">'.__('How to get an Private Key ?','vibe').'</a>',
						'std' => ''
						),
						array(
						...
						'sub_desc' => __('Google Maps require an API key to function', 'vibe').'<a href="https://wplms.io/supportknowledge-base/how-to-get-google-api-key-for-google-maps/">'.__('How to get an API Key ?','vibe').'</a>',
						'std' => ''
						),
                       array(
						'id' => 'contact_ll',
