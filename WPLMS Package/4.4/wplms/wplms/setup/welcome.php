...
class WPLMS_Admin_Welcome {
		...
		<div class="setup_wizard_wrapper">
			<div class="onboarding introduction">
				...
				<div class="onboarding_introduction">
					...
					<span><a>20 Changes</a>. 2 Features. 22 Enhancements . 31 Bug Fixes, since last update.</span>
				</div>
	...
	public function welcome_screen(){
		...
		<div class="welcome_slider">
		  	...
		  	<div class="slides">
		  		<div id="slide-1">
		  			<iframe width="560" height="315" src="https://www.youtube.com/embed/2oCL_VJqtzY?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
